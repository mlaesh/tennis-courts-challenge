...
public class TennisCourtService {
    ...
    public TennisCourtDTO findTennisCourtWithSchedulesById(Long tennisCourtId) {
        log.info("[TENNIS-COURT-SERVICE] - Looking for court id {}", tennisCourtId);
